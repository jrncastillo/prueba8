...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Employee',
            fields=[
                ('businessentityid', models.OneToOneField(db_column='businessentityid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='prueba8.person')),
